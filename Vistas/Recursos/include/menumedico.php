<div class="ui blue vertical menu">
    ...
    <a class="item" href="LayoutMedico.php?load=gestionpaciente"><i class="configure icon"></i>Gestion Cita Paciente</a>
    ...
    <a class="item" href="LayoutMedico.php?load=horario"><i class="user icon"></i>Horario</a>
